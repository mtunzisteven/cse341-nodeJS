...
exports.getProduct = (req, res, next) => {
    const prodId = req.params.productId; // variable productId extracted with this line
    Product.fetchById(prodId, product => { // cb is the arrow fn taking product as arg to return the product
      res.render('shop/product-detail', { // open shop page
        product: product, // set product obtained as value of product key
