...
class Feed extends Component {
  ...
  loadPosts = direction => { // load all posts from on the feed from the api url provided
    if (direction) {
  ...
  finishEditHandler = postData => { // postData is an argument that will hold data entered by user
    this.setState({
      editLoading: true
    });
